# Hasil Riset Pasar - Divisi Gallery (Senin)

## 3 Kandidat Produk Digital Potensial:
1. [Nama Produk 1, notion planner templates ]
     #### Deskripsi singkat:
   template design sistem pengaturan jadwal, tugas kuliah, dan produktivitas harian yang terstruktur di dalam platform Notion.
     #### Kelebihan:
     - pasar yang jelas dan luas dan banyak diminati oleh orang untuk mengatur jadwal harian
     - proses pembuatannya berbasis sistem komponen/blok, jadi sangat ramah untuk pemula uang belum menguasai software desain berat
     #### Kekurangan:
